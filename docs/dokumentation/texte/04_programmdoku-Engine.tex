...
\begin{itemize}
	...
	\item Eine weitere Liste, welche für jede Szene im Stapel
	      ...
	      und  Siehe auch \ref{programm:engine:szene:verdecken}.
\end{itemize}
...
begonnen bei $fromIndex - 1$ und endend bei $0$, jeweils inklusiv. Dabei
...
und \texttt{getPositionMicroseconds} sind trivial.
