...
Beim Minispiel der Fachschaft Chemie kann ein Reagenzglas mittels der linken Maustaste angegklickt werden. Das erste Reagenzglas, welches man anklickt wird visuell hervorgehoben und ist das Quellglas.
...
Durch das Loslassen wird die länge des Pfeils fixiert. Durch das Wiederholen dieses Vorgangs kann die Pfeillänge beliebig oft nachjustiert werden.
Durch das Klicken mit der linken Maustaste auf den \glqq{}Simulate\grqq{}-Button wird die Simulation (das Bewegen des Balls) gestartet.

\subsubsection{Biologie}
Beim Minispiel der Fachschaft Biologie kann ein Label durch das Klicken mit der linken Maustaste auf ausgewählt werden. Durch ein erneutes Klicken wird die Auswahl aufgehoben.
